...
type FindAllTodosHandler struct {
	UseCase todo.FindAllTodoUseCase
}

func (handler *FindAllTodosHandler) Handle(c *gin.Context) {
...
func (handler *FindAllTodosHandler) handle(c *gin.Context) *errors.APIError {
	...
	req := contracts.FindAllTodoRequest{}
